                ...
                <div class="p-4 border-b border-gray-200 shadow ">
                    <div class="bg-white">
                        <select name="qst" wire:model="qst_select"
                            ...
                            <option value=""> Selectioner les questions </option>
                            ...
                            <ul class="flex justify-center">
                                @foreach ($question3 as $question)
                                    <li><strong>Nom:</strong> {{ $question['par_nom'] }} <strong>Lieu:</strong>
                                        {{ $question['par_lieu'] }} <strong>Superficie:</strong>
                        ...
                        <div class="flex justify-center p-4">
                            ...
                            <ul>
                                @foreach ($question6 as $quest6)
                                    <li><strong>Debut d'intervention :</strong> {{ $quest6['int_debut'] }} <strong>le nom d la
